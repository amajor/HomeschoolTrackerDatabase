CREATE VIEW `view_tasks_to_grade` AS
SELECT
...
JOIN homeschool.users
  ...
  AND user_tasks.status_prep = 1
  AND user_tasks.status_complete = 1
  AND user_tasks.status_grade = 0
...
JOIN homeschool.subjects
  ...
  ORDER BY lesson_number, taskDescription